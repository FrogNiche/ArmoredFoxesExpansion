...
public class WarpedBadger extends Animal implements IAnimatable {

    public static final String CONTROLLER_NAME = "controller";

    private final AnimationFactory factory = new AnimationFactory(this);

    public static final EntityDataAccessor<Boolean> IN_SNOW = SynchedEntityData.defineId(WarpedBadger.class,
    ...
    public WarpedBadger(EntityType<WarpedBadger> type, Level level) {
        super(type, level);
    }
    ...
    private PlayState predicate(AnimationEvent<WarpedBadger> event) {
            if (event.isMoving()) {
